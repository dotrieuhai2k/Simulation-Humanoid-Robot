...
uLINK(BODY).R = eye(3);
%Setup TAY PHAI
uLINK(RARM_J0).q = -30.0*ToRad;
uLINK(RARM_J1).q = -30.0*ToRad;
uLINK(RARM_J2).q = 0;
uLINK(RARM_J3).q = -10.0*ToRad;
uLINK(RARM_J4).q = 0;
uLINK(RARM_J5).q = 0;
%Setup TAY TRAI
uLINK(LARM_J0).q = 30.0*ToRad;
uLINK(LARM_J1).q = 10.0*ToRad;
uLINK(LARM_J2).q = 0;
uLINK(LARM_J3).q = -50.0*ToRad;
uLINK(LARM_J4).q =0 ;
uLINK(LARM_J5).q = 0;

uLINK(RLEG_J2).q = -30.0*ToRad;
uLINK(RLEG_J3).q = 40.0*ToRad;
uLINK(RLEG_J4).q = 0;

uLINK(LLEG_J2).q = 30.0*ToRad;
uLINK(LLEG_J3).q = 40.0*ToRad;
uLINK(LLEG_J4).q = 0;
